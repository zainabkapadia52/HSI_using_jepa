...
def load_checkpoint(
    ...
    # get the last completed epoch (default to 0)
    ...
    # -- restore target_encoder if it was saved, otherwise sync it to encoder
    if 'target_encoder' in checkpoint and target_encoder is not None:
        ...
        # align its weights so momentum updates pick up correctly
